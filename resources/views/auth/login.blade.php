...
<html lang="ar" dir="rtl">
  <head>
    ...
    <title>Login - RealState Admin</title>
  </head>
  <body>
<div class="col-12 p-0 row" style="margin: 0">
    <div class="col-12 col-md-6 text-center p-0" style="background-color: #f8f9fa;">
    ...
    <div class="col-12 col-md-6 p-0 d-none d-md-block" >
            <div style="height: 100vh;background-image: url('{{asset('assets/images/logo.svg')}}');object-fit: cover;    vertical-align: middle;background-size: cover;background-repeat: no-repeat;"></div>
    </div>
</div>
